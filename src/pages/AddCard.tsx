    ...
    <div className="space-y-6">
      ...
      <div className="px-8 space-y-8">
        <div className="mb-10 perspective-1000">
          <div className="bg-transparent border border-white/10 shadow-2xl">
            ...
            <div className="flex justify-between items-start relative z-10">
              ...
              <span className="material-symbols-outlined text-text-label text-3xl">contactless</span>
            </div>
            <div className="relative z-10">
              <p className="text-text-label text-[10px] tracking-widest uppercase mb-1">Nome no Cartão</p>
            ...
            <div className="flex justify-between items-end relative z-10">
              <div className="flex gap-4">
                <div>
                  <p className="text-text-label text-[8px] tracking-widest uppercase">Expira</p>
        ...
        <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); navigate('/accounts'); }}>
          <div className="relative">
            <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-1">Nome do Cartão</label>
            <div className="flex items-center gap-3">
              <span className="material-symbols-outlined text-text-label">credit_card</span>
              <input
          ...
          <div className="relative py-2">
            <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-1">Limite Total</label>
            <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="relative">
              <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-1">Fechamento</label>
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-text-label text-xl">event_repeat</span>
            ...
            <div className="relative">
              <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-1">Vencimento</label>
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-text-label text-xl">event_available</span>
          ...
          <div className="space-y-6 pt-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-text-label">vibration</span>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-text-label">notifications_active</span>
