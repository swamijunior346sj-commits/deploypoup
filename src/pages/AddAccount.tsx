    ...
    <div className="space-y-6">
      ...
      <div className="px-8 space-y-8">
        <section className="py-8 text-center">
          <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-2">Saldo Inicial</label>
        ...
        <section className="space-y-6">
          <div>
            <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-4">Tipo de Conta</label>
            <div className="grid grid-cols-2 gap-3">
              ...
              <button className="flex flex-col items-center justify-center p-4 rounded-2xl bg-transparent border border-white/10">
                <span className="material-symbols-outlined text-text-label mb-2 text-2xl">savings</span>
                <span className="text-[10px] font-bold tracking-tight uppercase">Conta Poupança</span>
              </button>
              <button className="flex flex-col items-center justify-center p-4 rounded-2xl bg-transparent border border-white/10">
                <span className="material-symbols-outlined text-text-label mb-2 text-2xl">account_balance_wallet</span>
                <span className="text-[10px] font-bold tracking-tight uppercase">Carteira</span>
              </button>
              <button className="flex flex-col items-center justify-center p-4 rounded-2xl bg-transparent border border-white/10">
                <span className="material-symbols-outlined text-text-label mb-2 text-2xl">trending_up</span>
          ...
          <div className="pt-4">
            <label className="text-[10px] font-bold text-text-label tracking-[0.15em] uppercase block mb-4">Instituição Financeira</label>
            <div className="space-y-2">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-transparent border border-white/10">
            ...
            <button className="w-full mt-4 py-3 text-[10px] font-bold text-text-label tracking-widest uppercase border border-zinc-800 rounded-xl hover:bg-zinc-900 transition-colors">
              Ver Outros Bancos
            </button>
          </div>
