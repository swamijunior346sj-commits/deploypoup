                        ...
                        <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                            {icons.map((icon) => (
                                <button
                                    ...
                                    className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center active:scale-90 transition-all ${selectedIcon === icon
                ...
                <div className="bg-[#121212] rounded-[32px] p-6 border border-white/5 space-y-8">
                    <div className="space-y-2">
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <input
                                className="w-full bg-transparent border-none focus:ring-0 text-4xl font-display font-bold text-primary p-0 placeholder:text-primary/30"
                                type="text"
                                placeholder="0,00"
                                value={target}
