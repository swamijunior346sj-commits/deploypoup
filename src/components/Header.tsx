...
export default function Header({
    ...
    return (
        <>
            <header className={`${sticky ? 'fixed top-0 left-0 right-0 z-50' : ''} px-6 pt-12 pb-6 flex items-center justify-between bg-background-dark/80 backdrop-blur-md`}>
            ...
            {sticky && <div className="h-[104px] w-full" />}
        </>
    );
}
